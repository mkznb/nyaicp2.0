...
class MetingJSElement extends HTMLElement {
    ...
    _init() {
        ...
        this.api = this.meta.api || window.meting_api || 'https://api.zicheng.icu/api/music?server=:server&type=:type&id=:id&r=:r'
...
<div id="music-player-settings" class="mdui-dialog">
	...
	<div class="mdui-dialog-actions">
		<button class="mdui-btn mdui-ripple" mdui-dialog-confirm onclick="musicPlayerSaveSettings()">
			<i class="mdui-icon material-icons">done_all</i>保存配置并生效
		</button>
		<button class="mdui-btn mdui-ripple" mdui-dialog-cancel onclick="musicPlayerReadConfiguration()">
			<i class="mdui-icon material-icons">cancel</i>取消
		</button>
		<button class="mdui-btn mdui-ripple" mdui-dialog-close mdui-dialog="{target: '#music-player-settings-update'}" onclick="musicPlayerSettingsUpdate()">
...
<div id="music-player-settings-update" class="mdui-dialog">
	...
	<div class="mdui-dialog-actions">
		<button class="mdui-btn mdui-ripple" mdui-dialog-close mdui-dialog="{target: '#music-player-settings'}">
